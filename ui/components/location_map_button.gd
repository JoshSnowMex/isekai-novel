...
func build_visuals() -> void:
	...
	border_panel.offset_left = -3
	border_panel.offset_top = -3
	border_panel.offset_right = 3
	border_panel.offset_bottom = 3
...
func make_map_icon_border_style(is_hovered: bool) -> StyleBoxFlat:
	...
	if is_hovered:
		style.bg_color = Color(0.09, 0.055, 0.11, 0.46)
		style.border_color = Color(1.0, 0.78, 0.36, 0.95)
		style.shadow_color = Color(1.0, 0.70, 0.26, 0.34)
		style.shadow_size = 12
	else:
		style.bg_color = Color(0.02, 0.018, 0.030, 0.22)
		style.border_color = Color(0.58, 0.54, 0.70, 0.34)
